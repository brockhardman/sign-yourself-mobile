...
struct Constants {
    ...
    static let DASHBOARD_SCREEN = "DashboardScreen"
    static let MENU_SCREEN = "MenuScreen"
    static let CONTRIBUTION_SCREEN = "ContributionScreen"
    static let MAIN_SCREEN = "MainScreen"
    static let PROJECTS_SCREEN = "ProjectsScreen"
    ...
    static let PROJECT_DETAIL_SCREEN = "ProjectDetailScreen"
